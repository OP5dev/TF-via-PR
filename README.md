...
- Handling of interim build artifacts between `plan` and `apply` commands (e.g., zip archive); workaround with `arg-auto-approve: true` during `apply` to rebuild artifacts for provisioning.
